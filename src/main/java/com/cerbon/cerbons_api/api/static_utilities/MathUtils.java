...
public class MathUtils {
    ...
    /**
     * Checks if the distance between two vectors is less than a given distance.
     *
     * @param pos1 the first vector
     * @param pos2 the second vector
     * @param distance the distance to check against
     * @return true if the distance between pos1 and pos2 is less than the given distance, false otherwise
    ...
    /**
     * Checks if a vector is moving towards a center point.
     *
     * @param center the center point
     * @param pos the position of the vector
     * @param direction the direction of the vector
     * @return true if the vector is moving towards the center, false otherwise
     */
    ...
    /**
     * Calculates the direction from a source point to a target point.
     *
